...
import {
	...
	__facade_invoke__,
	__facade_register__,
} from "/mnt/storagehdd/sdf-work/soroflare/node_modules/wrangler/templates/middleware/common.ts";

import worker from "/mnt/storagehdd/sdf-work/soroflare/soroflare-wrangler/.wrangler/tmp/bundle-Ydq7Dk/middleware-insertion-facade.js";

// We need to preserve all of the exports from the worker
export * from "/mnt/storagehdd/sdf-work/soroflare/soroflare-wrangler/.wrangler/tmp/bundle-Ydq7Dk/middleware-insertion-facade.js";
